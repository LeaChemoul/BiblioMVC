...
public class Partie extends Observable {
     ...
     * @return Renvoie faux si on a fait le tour de joueurs.
     */
     ...
     * @param i Ligne.
     * @param j Colonne.
     * @return Renvoie vrai si le joueur peut jouer la pièce.
     */
     ...
     */
    private boolean peutPoserPiece(JoueurBlokus joueur, Piece piece, int i_row, int j_col) {
     ...
     */
    private boolean isAdjacentePieceAllie(Color couleur, int i, int j) {
     ...
     */
    private boolean isDiagonalePieceAllie(Color couleur, int i, int j) {
        Case[][] matP = plateau.getTableauJeu();
     ...
     * @return renvoie la couleur correspondante à l'entier donné.
     */
     ...
     * La liste de Piece de toutes les pieces utilisées pour une partie de Blokus.
     */
     ...
     * La liste de Piece réduites des pièces utilisées pour une partie de Blokus.
     */
