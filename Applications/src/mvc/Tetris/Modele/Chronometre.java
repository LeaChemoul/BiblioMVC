...
public class Chronometre {
    ...
    /**
     * Transforme un timestammp (secondes) en un temps (heure, minutes,secondes)
     * @param tempsS Timestamp en secondes.
     * @return Chaine de caractères correspondant au temps en heure, minutes, secondes
     */
    private static String timeToHMS(long tempsS) {
